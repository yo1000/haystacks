...
curl -L -o haystacks-assembly-<mysql|postgresql>-latest.jar \
  https://github.com/yo1000/haystacks/releases/download/v0.0.10/haystacks-assembly-<mysql|postgresql>-0.0.10.jar
...
curl -L -o haystacks-assembly-mysql-latest.jar \
  https://github.com/yo1000/haystacks/releases/download/v0.0.10/haystacks-assembly-mysql-0.0.10.jar
...
curl -L -o haystacks-assembly-postgresql-latest.jar \
  https://github.com/yo1000/haystacks/releases/download/v0.0.10/haystacks-assembly-postgresql-0.0.10.jar
